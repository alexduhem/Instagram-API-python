...
class InstagramAPI:
    ...
    def from_json(self, json):
        self.device_id = json["device_id"]
        self.username = json["username"]
        self.password = json["password"]
        self.uuid = json["uuid"]
        self.isLoggedIn = json["isLoggedIn"]
        self.username_id = json["username_id"]
        self.rank_token = json["rank_token"]
        self.token = json["token"]
        self.LastResponse = None
        self.s = requests.Session()
        jar = requests.cookies.RequestsCookieJar()
        for key, morsel in json["cookies"].items():
